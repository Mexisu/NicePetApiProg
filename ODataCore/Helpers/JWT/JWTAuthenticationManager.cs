...
namespace Nicepet_API
{
    ...
    {
        AuthenticationResponse Authenticate(string username, string role);
    ...
    public class JWTAuthenticationManager : IJWTAuthenticationManager
    {
        ...
        public AuthenticationResponse Authenticate(string username, string role)
        {
        ...
        string GenerateTokenString(string username, DateTime expires, Claim[] claims )
        {
